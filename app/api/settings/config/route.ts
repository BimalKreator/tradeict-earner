...
export async function GET() {
  try {
    ...
    return NextResponse.json({
      ...
      fixedCapitalPerTrade: typeof parsed.fixedCapitalPerTrade === "number" ? parsed.fixedCapitalPerTrade : DEFAULT_CONFIG.fixedCapitalPerTrade,
...
export async function POST(request: Request) {
  ...
  try {
    ...
    const config = {
      ...
      fixedCapitalPerTrade: typeof body.fixedCapitalPerTrade === "number" ? body.fixedCapitalPerTrade : DEFAULT_CONFIG.fixedCapitalPerTrade,
